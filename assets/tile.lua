...
function CreateScene()
    ...
    cameraNode.position = Vector3(0.0, 0.0, -100.0)
    ...
    -- Get tmx file
    local tmxFile = cache:GetResource("TmxFile2D", "ashers_level4.tmx")
    if tmxFile == nil then
        return
    end
...
function CreateInstructions()
    ...
    instructionText:SetFont(cache:GetResource("Font", "Fonts/BlueHighway.ttf"), 15)
